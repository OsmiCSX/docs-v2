...
**bg-black** | `{ backgroundColor: "rgba(0, 0, 0, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(0, 0, 0, 1)" }} />
**bg-white** | `{ backgroundColor: "rgba(255, 255, 255, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(255, 255, 255, 1)" }} />
**bg-gray-50** | `{ backgroundColor: "rgba(249, 250, 251, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(249, 250, 251, 1)" }} />
**bg-gray-100** | `{ backgroundColor: "rgba(243, 244, 246, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(243, 244, 246, 1)" }} />
**bg-gray-200** | `{ backgroundColor: "rgba(229, 231, 235, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(229, 231, 235, 1)" }} />
**bg-gray-300** | `{ backgroundColor: "rgba(209, 213, 219, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(209, 213, 219, 1)" }} />
**bg-gray-400** | `{ backgroundColor: "rgba(156, 163, 175, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(156, 163, 175, 1)" }} />
**bg-gray-500** | `{ backgroundColor: "rgba(107, 114, 128, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(107, 114, 128, 1)" }} />
**bg-gray-600** | `{ backgroundColor: "rgba(75, 85, 99, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(75, 85, 99, 1)" }} />
**bg-gray-700** | `{ backgroundColor: "rgba(55, 65, 81, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(55, 65, 81, 1)" }} />
**bg-gray-800** | `{ backgroundColor: "rgba(31, 41, 55, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(31, 41, 55, 1)" }} />
**bg-gray-900** | `{ backgroundColor: "rgba(17, 24, 39, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(17, 24, 39, 1)" }} />
...
**bg-red-700** | `{ backgroundColor: "rgba(185, 28, 28, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(185, 28, 28, 1)" }} />
...
**bg-yellow-900** | `{ backgroundColor: "rgba(120, 53, 15, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(120, 53, 15, 1)" }} />
...
**bg-blue-300** | `{ backgroundColor: "rgba(147, 197, 253, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(147, 197, 253, 1)" }} />
...
**bg-purple-500** | `{ backgroundColor: "rgba(139, 92, 246, 1)" }` | <div className="preview" style={{ backgroundColor: "rgba(139, 92, 246, 1)" }} />
